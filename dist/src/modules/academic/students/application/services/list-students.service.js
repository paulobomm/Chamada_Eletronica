...
let ListStudentsService = class ListStudentsService {
    studentRepository;
    ...
    async execute() {
        ...
        return response.map((row) => student_dto_1.StudentDto.fromStudent(row));
    }
};
exports.ListStudentsService = ListStudentsService;
exports.ListStudentsService = ListStudentsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(student_repository_interface_1.STUDENT_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], ListStudentsService);
//# sourceMappingURL=list-students.service.js.map